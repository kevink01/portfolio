	...
	return (
		<div className='flex flex-col items-center justify-center w-screen h-screen text-white overflow-y-auto'>
			<div className='flex flex-col items-center justify-center flex-1 w-full px-4'>
				<div className='relative w-full max-w-2xl min-h-32 h-full max-h-240 my-4 bg-card rounded-20'>
					<div className='absolute inset-y-0 inset-x-2 flex flex-col py-2 overflow-y-auto'>
