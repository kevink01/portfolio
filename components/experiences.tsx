...
function Experiences() {
	...
	return (
		<div className="flex flex-col items-center p-2 1920:space-y-10 w-screen h-screen text-white">
			<h1 className="flex items-end h-10 1024:h-12 text-xl tablet:text-2xl 1024:text-3xl 1920:text-4xl tracking-widest text-slate-300">
				Experience
			</h1>
			<div className="flex flex-1 1920:flex-grow-0 flex-row justify-center space-x-2 w-full h-auto">
				...
				<div className="flex items-center overflow-hidden">
					<div
						className={`flex w-52 tablet:w-80 1024:w-120 1280:w-144 1536:w-150 1920:w-160 2560:w-300 h-96 tablet:h-160 2560:h-240 transition-transform ease-out duration-500`}
