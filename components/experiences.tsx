...
function Experiences() {
	...
	return (
		<div className="flex flex-col items-center p-2 space-x-0 24:space-y-2 w-screen h-screen text-white">
			...
			<div className="flex flex-row justify-center space-x-2 w-full h-auto 24:h-160">
				...
				<div className="relative flex items-center overflow-hidden h-96 24:h-160">
					<div
