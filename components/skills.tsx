...
function Skills({ skills }: Props) {
	return (
		...
		// 		Skills
		// 	</h1>
		// 	<div className='bg-gradient-to-b from-card/50 via-primary/30 to-primary rounded-20 flex flex-col flex-1 overflow-x-hidden overflow-y-auto w-full h-full px-4'>
		// 		{skills.length > 0 && (
		// 			<motion.div
