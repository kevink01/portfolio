		...
		<div className="flex flex-col flex-shrink-0 justify-between w-full h-full py-2 rounded-20 bg-gradient-to-b from-card/50 via-primary/10 to-primary">
			...
			<div className="space-y-1">
				...
				<div className="flex flex-row justify-center space-x-2 w-full h-full">
					<Link href="#skills">
						<button className="w-20 tablet:w-30 h-10 rounded-20 bg-secondary transition duration-500 ease-in-out hover:scale-110 hover:bg-secondaryHover text-sm 1024:text-lg">
							Source code
						</button>
					</Link>
					<Link href="#skills">
